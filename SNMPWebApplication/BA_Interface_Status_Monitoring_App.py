...
# SNMP based interface operating status monitoring application - BA - a MPLS (i.e. Juniper Legacy Switch) core switch
...
while True:
    ...
    for ifs in if_stat:
        ...
        if (obj_list[10] == '504' or obj_list[10] == '508' or obj_list[10] == '510' or obj_list[10] == '516'):
            ...
            print '\n\n'
    with open("Events/Interface/BA_Operational_Status.json", "w") as json_file:
