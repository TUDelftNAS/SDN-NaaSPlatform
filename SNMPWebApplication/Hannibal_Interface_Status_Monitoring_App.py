...
# SNMP based interface operating status monitoring application - Hannibal - a MPLS (i.e. Juniper Legacy Switch) core switch
...
while True:
    ...
    for ifs in if_stat:
        ...
        if (obj_list[10] == '503' or obj_list[10] == '505' or obj_list[10] == '506'):
            ...
            print '\n\n'
    with open("Events/Interface/Hannibal_Operational_Status.json", "w") as json_file:
