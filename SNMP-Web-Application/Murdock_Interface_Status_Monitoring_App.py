...
# SNMP based interface operating status monitoring application - Murdock - a MPLS (i.e. Juniper Legacy Switch) core switch
...
while True:
    ...
    for ifs in if_stat:
        ...
        if (obj_list[10] == '504' or obj_list[10] == '509' or obj_list[10] == '513' or obj_list[10] == '508'):
            ...
            print '\n\n'
    with open("Events/Interface/Murdock_Operational_Status.json", "w") as json_file:
