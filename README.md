...
SDN-NaaSPlatform is a software based application platform, which is written and developed as a step towards realizing a SDN-based architecture for Network-as-a-Service (NaaS) cloud-based service model.
